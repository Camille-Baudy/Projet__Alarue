        ...
        <br>
            ...
            <form role="form" method="POST" action="index.php?action=modifierInfoOrganisation">
                <p>Lieu : <select name='idLieu' id='idLieu' class="form-control">
                    ...
                    <?php foreach($lesLieux as $unLieu){ if($unLieu['idLieu']==$lOrganisation['idLieu']){ $newSecu="1"; } } ?>
                ...
                <?php foreach($lesBenevolesInscrits as $unBenevoleInscrit): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger btn-lg" data-toggle="modal" data-target="#<?php echo "t_".$unBenevoleInscrit['idUtilisateur'] ?>">✖︎</button>

                            COMMENTAIRE : Modal 
                            <div class="modal fade" id="<?php echo "t_".$unBenevoleInscrit['idUtilisateur'] ?>" role="dialog">
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <p>Vous souhaitez retirer : <strong><?php echo $unBenevoleInscrit['nom'];?> </strong> <?php echo $unBenevoleInscrit['prenom']; ?></p>
                                        </div>
