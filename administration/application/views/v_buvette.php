    ...
    <div class="container">
        ...
        <form role="form" method="POST" action="index.php?action=excelType">
            <br>
            <input id="prodId" name="type" type="hidden" value="Buvette">
            ...
            <h1>Liste buvettes</h1>
            <button><img src="<?php echo IMG."excel.png" ?>" height="10%" width="10%"> conversion en excel - buvettes </button>
        </form>
        
        <br>
        <form role="form" method="POST" action="index.php?action=chercherBuvettes">
            ...
            <br>
            <input class="zone btn btn-outline-secondary" type="submit" value="Rechercher des bénévoles pour la mission buvette" size="20" />
        </form>
                            ...
                            <td class="noline plain">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <form role="form" method="POST" action="index.php?action=ajouterBuvette"> 
                                        <div class="col-8">
                                        ...
                                        <input id="prodId" name="lieu" type="hidden" value="Lieu à définir">
                                        <?php if($unI != 0): ?>
                                        ...
                                        <td>                                           
                                            ...
                                            <?php foreach($lesBenevoles as $unBenevole):?>
                                                <?php if($unBenevole['idUtilisateur']==$unHoraireBenevole['idUtilisateur']): ?>
                                                    <form role="form" method="POST" action="index.php?action=supprimerBuvette">
                                                        <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
