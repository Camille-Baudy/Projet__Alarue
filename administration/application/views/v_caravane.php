    ...
    <div class="container">
        ...
        <form role="form" method="POST" action="index.php?action=excelType">
            <br>
            <input id="prodId" name="type" type="hidden" value="Caravane">
            ...
            <h1>Liste caravanes</h1>
            <button><img src="<?php echo IMG."excel.png" ?>" height="10%" width="10%"> conversion en excel - caravanes </button>
        </form>
        
        <br>
        <form role="form" method="POST" action="index.php?action=chercherCaravanes">
            ...
            <br>
            <input class="zone btn btn-outline-secondary" type="submit" value="Rechercher des bénévoles pour la mission Caravane" size="20" />
        </form>
                ...
                <tbody>
                    ...
                    <?php while ($uneDateDebut < $uneDateFin): ?>
                        ...
                        <tr>
                            ...
                            <!-- LIEU -->
                            <td>
                            <form role="form" method="POST" action="index.php?action=addLieuMissionC">
                            ...
                            <td class="noline plain">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <form role="form" method="POST" action="index.php?action=ajouterCaravane"> 
                                        <div class="col-8">
                                        ...
                                        <?php                                         
                                        require_once MODELSPATH.'f_administrateur.php';
                                        $leLieu=personne\getLeLieuMission(3, $uneDateDebut); 
                                        $varLieu = "";
                            ...
                            <?php 
                            require_once MODELSPATH.'f_administrateur.php';
                            $lieuChoisi=personne\getLieuChoisi(3, $uneDateDebut);
                            ?>
                            <?php
                            if ($lieuChoisi!=null) {
                            ...
                            <form role="form" method="POST" action="index.php?action=supprimerLieuChoisiMissionAP">
                                <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
                                <input id="prodId" name="idMission" type="hidden" value=3>
                                        ...
                                        <td>                                           
                                            ...
                                            <?php foreach($lesBenevoles as $unBenevole):?>
                                                <?php if($unBenevole['idUtilisateur']==$unHoraireBenevole['idUtilisateur']): ?>
                                                    <form role="form" method="POST" action="index.php?action=supprimerCaravane">
                                                        <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
