    ...
    <div class="container">
        ...
        <form role="form" method="POST" action="index.php?action=excelType">
            <br>
            <input id="prodId" name="type" type="hidden" value="Deco">
            ...
            <h1>Liste décorations</h1>
            <button><img src="<?php echo IMG."excel.png" ?>" height="10%" width="10%"> conversion en excel - décorations </button>
        </form>
        
        <br>
        <form role="form" method="POST" action="index.php?action=chercherDecos">
            ...
            <br>
            <input class="zone btn btn-outline-secondary" type="submit" value="Rechercher des bénévoles pour la mission décoration" size="20" />
        </form>
                ...
                <tbody>
                    ...
                    <?php while ($uneDateDebut < $uneDateFin): ?>
                        ...
                        <tr>
                            ...
                            <!-- LIEU -->
                            <td>
                            <form role="form" method="POST" action="index.php?action=addLieuMissionD">
                            ...
                            <td class="noline plain">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <form role="form" method="POST" action="index.php?action=ajouterDeco"> 
                                        <div class="col-8">
                                        ...
                                        <?php                                         
                                        require_once MODELSPATH.'f_administrateur.php';
                                        $leLieu=personne\getLeLieuMission(1, $uneDateDebut); 
                                        $varLieu = "";
                            ...
                            <?php 
                            require_once MODELSPATH.'f_administrateur.php';
                            $lieuChoisi=personne\getLieuChoisi(1, $uneDateDebut);
                            ?>
                            <?php
                            if ($lieuChoisi!=null) {
                            ...
                            <form role="form" method="POST" action="index.php?action=supprimerLieuChoisiMissionAP">
                                <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
                                <input id="prodId" name="idMission" type="hidden" value=1>
