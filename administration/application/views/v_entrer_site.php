    ...
    <div class="container">
        ...
        <form role="form" method="POST" action="index.php?action=excelType">
            <br>
            <input id="prodId" name="type" type="hidden" value="EntréeSite">
            ...
            <h1>Liste entrée site</h1>
            <button><img src="<?php echo IMG."excel.png" ?>" height="10%" width="10%"> conversion en excel - entrée site </button>
        </form>
        
        <br>
        <form role="form" method="POST" action="index.php?action=chercherEntrerSite">
            ...
            <br>
            <input class="zone btn btn-outline-secondary" type="submit" value="Rechercher des bénévoles pour la mission entrée site" size="20" />
        </form>
                ...
                <tbody>
                    ...
                    <?php while ($uneDateDebut < $uneDateFin): ?>
                        ...
                        <tr>
                            ...
                            <form role="form" method="POST" action="index.php?action=addLieuMissionES">
                            ...
                            <td class="noline plain">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <form role="form" method="POST" action="index.php?action=ajouterBenevoleEntreeSite"> 
                                        <div class="col-8">
                                        ...
                                        <?php                                         
                                        require_once MODELSPATH.'f_administrateur.php';
                                        $leLieu=personne\getLeLieuMission(8, $uneDateDebut); 
                                        $varLieu = "";
                            ...
                            <td>
                                ...
                                <?php 
                                require_once MODELSPATH.'f_administrateur.php';
                                $lieuChoisi=personne\getLieuChoisi(8, $uneDateDebut);
                                ?>
                                ...
                                if ($lieuChoisi!=null) {
                                    foreach ($lieuChoisi as $lC) {
                                        ?>
                                <form role="form" method="POST" action="index.php?action=supprimerLieuChoisiMissionES">
                                    <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
                                    <input id="prodId" name="idMission" type="hidden" value=8>
                                        ...
                                        <td>                                           
                                            ...
                                            <?php foreach($lesBenevoles as $unBenevole):?>
                                                <?php if($unBenevole['idUtilisateur']==$unHoraireBenevole['idUtilisateur']): ?>
                                                    <form role="form" method="POST" action="index.php?action=supprimerBenevoleEntrerSite">
                                                        <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
