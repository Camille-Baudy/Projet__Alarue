    ...
    <div class="container">
        ...
        <form role="form" method="POST" action="index.php?action=excelType">
            <br>
            <input id="prodId" name="type" type="hidden" value="Logistique">
            ...
            <h1>Liste logistique</h1>
            <button><img src="<?php echo IMG."excel.png" ?>" height="10%" width="10%"> conversion en excel - logistique </button>
        </form>
        
        <br>
        <form role="form" method="POST" action="index.php?action=chercherLogistiques">
            ...
            <br>
            <input class="zone btn btn-outline-secondary" type="submit" value="Rechercher des bénévoles pour la mission logistique" size="20" />
        </form>
                ...
                <tbody>
                    ...
                    <?php while ($uneDateDebut < $uneDateFin): ?>
                        ...
                        <tr>
                            ...
                            <!-- LIEU -->
                            <td>
                            <form role="form" method="POST" action="index.php?action=addLieuMissionL">
                            ...
                            <td class="noline plain">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        ...
                                        <form role="form" method="POST" action="index.php?action=ajouterLogistique"> 
                                        <div class="col-8">
                                        ...
                                        <?php                                         
                                        require_once MODELSPATH.'f_administrateur.php';
                                        $leLieu=personne\getLeLieuMission(7, $uneDateDebut); 
                                        $varLieu = "";
                            ...
                            <?php 
                            require_once MODELSPATH.'f_administrateur.php';
                            $lieuChoisi=personne\getLieuChoisi(7, $uneDateDebut);
                            ?>
                            <?php
                            if ($lieuChoisi!=null) {
                            ...
                            <form role="form" method="POST" action="index.php?action=supprimerLieuChoisiMissionAP">
                                <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
                                <input id="prodId" name="idMission" type="hidden" value=7>
                                        ...
                                        <td>                                           
                                            ...
                                            <?php foreach($lesBenevoles as $unBenevole):?>
                                                <?php if($unBenevole['idUtilisateur']==$unHoraireBenevole['idUtilisateur']): ?>
                                                    <form role="form" method="POST" action="index.php?action=supprimerLogistique">
                                                        <input id="prodId" name="dateDebut" type="hidden" value="<?php echo $uneDateDebut ?>">
