        ...
        <div class="row">
            <div class="col-lg-12 text-center">
				...
				<div class="alert alert-success text-left" role="alert">
					...
					<hr>
					<p class="mb-0"><ul>
						<li>Vous pouvez modifier vos disponibilités en étirant une case puis double-cliquer sur celle-ci, enfin cliquez sur le bouton 'Sauvegarder' ou bien en déplaçant votre disponibilité et cliquez sur le bouton 'Sauvegarder'.</li>
