             ...
             <form>
               <fieldset>
                ...
                <label for="permis">Avez-vous le permis ?</label>
                   ...
                   <label for="voiture">Si oui, avez-vous une voiture personnelle ?</label>
                    <div class="form-check">
                 ...
                 <label for="anciennete">Avez-vous été bénévole aux Zaccros d'ma rue?</label>
                    <div class="form-check">
				   ...
				   <br />
                    <div class="form-group">
                        <label for="benevoleAmis">Y a t-il un/des bénévole(s) avec qui vous voudrez particulièrement travailler cette année ?</label>
                        <input type="text" class="form-control" name="benevoleAmis" placeholder="Entrez le nom de votre/vos ami(e.s)">
                    </div>
                   
                    <label for="mission">Comment avez-vous eu connaissance du festival ?</label><label class="text-danger">&nbsp*</label>
